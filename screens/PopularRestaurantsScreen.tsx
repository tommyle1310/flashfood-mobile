...
type PopularRestaurantsSreenNavigationProp = StackNavigationProp<
  MainStackParamList,
  "PopularRestaurants"
>;

type PopularRestaurantsRouteProp = RouteProp<MainStackParamList, "PopularRestaurants">;
...
const PopularRestaurantsScreen = () => {
  const navigation = useNavigation<PopularRestaurantsSreenNavigationProp>();
  const route = useRoute<PopularRestaurantsRouteProp>();
  ...
  return (
    <FFSafeAreaView>
      <FFScreenTopSection navigation={navigation} title="Popular Restaurants" />
      <FlatList
        data={restaurantList}
...
export default PopularRestaurantsScreen;